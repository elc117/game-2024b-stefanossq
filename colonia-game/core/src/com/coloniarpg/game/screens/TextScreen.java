...
public class TextScreen implements Screen {
    ...
    public void show() {
        ...
        if (dead) { // Se o jogador morreu, cria o texto de perdeu
        ...
        } else { // Se o jogador venceu, cria o texto de venceu e adiciona a informação do item ganho
            ...
            // Adiciona o texto de item ganho
            Image itemText = new Image(new TextureRegionDrawable(AssetUtils.ganhouItemText));
            itemText.setPosition(windowWidth / 2 - AssetUtils.ganhouItemText.getWidth() / 2, windowHeight / 2 - AssetUtils.ganhouItemText.getHeight() / 2 - 50);
            itemText.setScale(2);
            itemText.setOrigin(itemText.getWidth() / 2, itemText.getHeight() / 2);
            stage.addActor(itemText);
        }
